...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // writable database reference
        mDb = waitlistDbHelper.getWritableDatabase();

        TestUtil.insertFakeData(mDb);

        // getAllGuests function and store the result in a Cursor variable
    ...
    public void addToWaitlist(View view) {
        ...
        long success = addNewGuest(mNewGuestNameEditText.getText().toString(), partySize);
